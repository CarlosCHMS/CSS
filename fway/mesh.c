...
void meshCalcCup(MESH* mesh, int ii, int jj, double* xc, double* yc)
{
    ...
    double y;
    *yc = (mesh->y[ii+1][jj+1] + mesh->y[ii][jj+1])*0.5;
    *xc = (mesh->x[ii+1][jj+1] + mesh->x[ii][jj+1])*0.5;
...
void meshCalcCright(MESH* mesh, int ii, int jj, double* xc, double* yc)
{
    ...
    double y;
    *yc = (mesh->y[ii+1][jj+1] + mesh->y[ii+1][jj])*0.5;
    *xc = (mesh->x[ii+1][jj+1] + mesh->x[ii+1][jj])*0.5;
...
void meshCalcCdown(MESH* mesh, int ii, int jj, double* xc, double* yc)
{
    ...
    double y;
    *yc = (mesh->y[ii+1][jj] + mesh->y[ii][jj])*0.5;
    *xc = (mesh->x[ii+1][jj] + mesh->x[ii][jj])*0.5;
...
void meshCalcCleft(MESH* mesh, int ii, int jj, double* xc, double* yc)
{
    ...
    double y;
    *yc = (mesh->y[ii][jj+1] + mesh->y[ii][jj])*0.5;
    *xc = (mesh->x[ii][jj+1] + mesh->x[ii][jj])*0.5;
...
void meshCalcC(MESH* mesh, int ii, int jj, double* xc, double* yc)
{
    ...
    double y;
    *yc = (mesh->y[ii][jj+1] + mesh->y[ii][jj] + mesh->y[ii+1][jj+1] + mesh->y[ii+1][jj])*0.25;
    *xc = (mesh->x[ii][jj+1] + mesh->x[ii][jj] + mesh->x[ii+1][jj+1] + mesh->x[ii+1][jj])*0.25;
